      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          <Image
            ...
            className="mb-3"
          />
          <span className="text-xl text-blue-500">Optimiza</span>
        </a>
        ...
        <button className="hidden  md:inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none rounded-3xl text-lg">
          Request a Demo
        </button>
      </div>
    </header>
...
export default function Home() {
  return (
    <div className="">
      ...
      {/*  */}
      <section className="text-gray-600 body-font px-3 md:mx-24">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              Optimize your business
              <br className="hidden lg:inline-block" />
              with<span className="text-blue-500"> Optimiza</span>
            </h1>
            ...
            <div className="flex justify-center">
              <button className="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none rounded-3xl text-lg">
                Try it now
              </button>
              <button className="ml-4 inline-flex text-gray-700 border-2 border-black py-2 px-6 focus:outline-none rounded-3xl text-lg">
                Learn more
              </button>
            </div>
          </div>
      ...
      {/*  */}
      <section className="text-gray-600 body-font md:mx-24">
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
            <img
              ...
              src="https://picsum.photos/460/500?random=1"
            />
          </div>
      ...
      {/*  */}
      <footer className="text-gray-600 body-font md:mx-24">
